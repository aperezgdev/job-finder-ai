...
6. Each new offer triggers AI rating.
7. If the threshold is met, a Telegram notification is sent.
...
6. Cada oferta nueva dispara rating IA.
7. Si cumple umbral, se envía notificación por Telegram.
